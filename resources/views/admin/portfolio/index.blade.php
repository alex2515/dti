		            	...
		            	<div class="table-responsive">
		            		<table id="example1" class="table table-striped table-bordered table-hover table-condensed" style="width:100%">
				                ...
				                <tbody>
									...
									<tr>
										<td>{{ $portfolio->id }}</td>
										<td>{{ $portfolio->post->name }}</td>
										<td width="10px">
											@can('portfolios.show')
											<a href="{{ route('portfolios.show', $portfolio->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-eye" style="font-size: 15px;"></i></a>
											@endcan
										</td>
										<td width="10px">
											@can('portfolios.edit')
											<a href="{{ route('portfolios.edit', $portfolio->id) }}" class="btn btn-sm btn-success"><i class="fa fa-pencil-square-o" style="font-size: 15px;"></i></a>
											@endcan
										</td>
										<td width="10px">
											@can('portfolios.destroy')
											<a href="" data-target="#modal-delete-{{$portfolio->id}}" data-toggle="modal"><button class="btn btn-sm btn-danger"><i class="fa fa-trash-o" style="font-size: 15px;"></i></button></a>
											@endcan
										</td>
									</tr>
