		            		...
		            		<table id="example1" class="table table-striped table-bordered table-hover table-condensed" style="width:100%">
				                ...
				                <tbody>
									...
									<tr>
										...
										<td width="10px">
											@can('posts.show')
											<a href="{{ route('posts.show', $post->id) }}" class="btn btn-sm btn-warning">Ver</a>
											@endcan
										</td>
										<td width="10px">
											@can('posts.edit')
											<a href="{{ route('posts.edit', $post->id) }}" class="btn btn-sm btn-success">Editar</a>
											@endcan
										</td>
										<td width="10px">
											@can('posts.destroy')
											<a href="" data-target="#modal-delete-{{$post->id}}" data-toggle="modal"><button class="btn btn-sm btn-danger">Eliminar</button></a>
