			...
			<div class="col-md-12">
				<div class="box box-primary">
		            <div class="box-header">
		            	...
		            	@can('posts.create')
						<a href="{{ route('posts.create') }}" class="btn btn-success pull-right"><span class="fa fa-plus"></span> Agregar</a>
						@endcan
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		            		...
		            		<table id="example1" class="table table-striped table-bordered table-hover table-condensed" style="width:100%">
				                ...
				                <tbody>
									...
									<tr>
										...
										<td width="10px">
											@can('posts.show')
											<a href="{{ route('posts.show', $post->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-eye" style="font-size: 15px;"></i></a>
											@endcan
										</td>
										<td width="10px">
											@can('posts.edit')
											<a href="{{ route('posts.edit', $post->id) }}" class="btn btn-sm btn-success"><i class="fa fa-pencil-square-o" style="font-size: 15px;"></i></a>
											@endcan
										</td>
										<td width="10px">
											@can('posts.destroy')
											<a href="" data-target="#modal-delete-{{$post->id}}" data-toggle="modal"><button class="btn btn-sm btn-danger"><i class="fa fa-trash-o" style="font-size: 15px;"></i></button></a>
		            	...
		            	@else
		            		<p class="text-red text-center"><strong>No hay eventos registrados.</strong></p>
		            	@endif	                
		            </div>
		            <!-- /.box-body -->
		        </div>
