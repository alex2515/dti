<div class="col-md-8 col-md-offset-2">
	<div class="box box-primary ">
		<div class="box-header  with-border">
			<h3 class="box-title">Agregar nuevo Presentación</h3><a href="{{ route('presentations.index') }}" class="badge bg-orange pull-right"><< Ver Lista</a>
		</div>
		<div class="box-body">
			{{ Form::label('note', 'Los campos con (*) son olbigatorios', ['class' => 'text-red']) }}
			<div class="form-group">
				{{ Form::label('title', 'Título ') }}
				{{ Form::text('title', null, ['class' => 'form-control', 'id' =>'title', 'placeholder' => 'Nombre ...']) }}
			</div>
			<div class="form-group">
				{{ Form::label('image', 'Seleccionar imagen') }}
				{{ Form::file('file') }}
				<p class="help-block pull-right">(Tamaño recomendado: ancho 1920px y alto 1300px </p>
			</div>
			<div class="form-group">
