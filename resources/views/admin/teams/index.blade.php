		            		...
		            		<table id="example1" class="table table-striped table-bordered table-hover table-condensed" style="width:100%">
				                ...
				                <tbody>
									...
									<tr>
										...
										<td width="10px">
											@can('teams.show')
											<a href="{{ route('teams.show', $team->id) }}" class="btn btn-sm btn-warning">Ver</a>
											@endcan
										</td>
										<td width="10px">
											@can('teams.edit')
											<a href="{{ route('teams.edit', $team->id) }}" class="btn btn-sm btn-success">Editar</a>
											@endcan
										</td>
										<td width="10px">
											@can('teams.destroy')
											<a href="" data-target="#modal-delete-{{$team->id}}" data-toggle="modal"><button class="btn btn-sm btn-danger">Eliminar</button></a>
											@endcan
										</td>
									</tr>
