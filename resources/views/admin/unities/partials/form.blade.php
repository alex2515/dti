<div class="col-md-8 col-md-offset-2">
	<div class="box box-primary ">
		<div class="box-header  with-border">
			<h3 class="box-title">Agregar nueva unidad</h3><a href="{{ route('unities.index') }}" class="badge bg-orange pull-right"><< Ver Lista</a>
		</div>
		<div class="box-body">
			...
			<div class="form-group">
				{{ Form::label('icon', 'Buscar Icono (*)') }}
				<button type="button" class="btn btn-link" data-toggle="modal" data-target=".bs-example-modal-lg">Ver iconos disponibles</button>
			...
			<div class="form-group">
				...
				<p class="help-block pull-right">(máximo: 500 carácteres) </p>
			</div>
		</div>
